...
use Webkul\API\Http\Controllers\Shop\HomePageController;
use Webkul\API\Http\Controllers\Shop\ContactUsController;
use Webkul\API\Http\Controllers\Shop\QuoteController;
use Webkul\API\Http\Controllers\Shop\HeaderController;
use Webkul\API\Http\Controllers\Shop\AboutUsController;
use Webkul\API\Http\Controllers\Shop\RelatedProductsController;
use Webkul\API\Http\Controllers\Shop\SlugProductsController;
use Webkul\API\Http\Controllers\Shop\ResetPaswordController;
use Webkul\API\Http\Controllers\Shop\CategorySlugController;
use Webkul\API\Http\Controllers\Shop\FrechProductsController;
use Webkul\API\Http\Controllers\Shop\SearchController;
...
Route::group(['prefix' => 'api'], function ($router) {
    ...
    Route::group(['middleware' => ['locale', 'theme', 'currency']], function ($router) {
        ...
        // 
        Route::get('Homepagecontent', [HomePageController::class, 'Homepagecontent']);
        ...
        Route::get('frech-header', [HeaderController::class, 'headersfrench']);

        Route::get('about-us', [AboutUsController::class, 'about_us']);

        Route::get('about-us-fr', [AboutUsController::class, 'about_us_french']);

        Route::get('contactus-data', [ContactUsController::class, 'contactusdata']);

        Route::get('contactus-data-fr', [ContactUsController::class, 'contactusdatafr']);

        Route::get('related-products', [RelatedProductsController::class, 'related']);

        Route::get('products-slug/{slug}', [RelatedProductsController::class, 'slugs']);
        
        Route::post('resetpasword', [ResetPaswordController::class, 'resetpaswords']);

        Route::post('updatepasword', [ResetPaswordController::class, 'updatepassword']);
        
        Route::post('passsword-reset', [ResetPaswordController::class, 'passwordreset']);

        Route::get('slug-csv', [CategorySlugController::class, 'csvslug']);

        Route::post('category-slug', [CategorySlugController::class, 'productcategoryslug']);

        Route::get('latest-product', [ProductController::class, 'lates_product']);

        Route::get('search', [SearchController::class, 'searches']);

        Route::get('allsearch', [SearchController::class, 'all_search']);


        // 

        // french locale api
        Route::get('product-frech', [FrechProductsController::class, 'productfrech']);

        Route::get('latest-product-frech', [FrechProductsController::class, 'latest_productfrech']);

        // Route::get('french-category/{slug}', [FrechProductsController::class, 'categoryfrench']);

        // Route::get('french-category', [FrechProductsController::class, 'fetchCategories']);

        Route::get('french-category', [FrechProductsController::class, 'cslug']);

        Route::get('product-by-category', [FrechProductsController::class, 'productbycategory']);

        Route::get('Homepage-french-content', [HomePageController::class, 'Homefrechpagecontent']);
