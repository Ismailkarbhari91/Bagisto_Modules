...
class AuthController extends CustomerController
{
    ...
    public function register(Request $request)
    {
        ...
        Mail::send('emails.regiter',['usernames' => $username,'passwords' =>$password], function ($message) use ($email) {
            $message->to($email);
            $message->subject('Your European Lorry Parts Industry account has been created!');
        });
