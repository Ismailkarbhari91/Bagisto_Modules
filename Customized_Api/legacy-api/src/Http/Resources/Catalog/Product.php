...
class Product extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'product_fields_0_title' => $product->product_fields_0_title,
            'product_fields_0_value' => $product->product_fields_0_value,
            'product_fields_1_title' => $product->product_fields_1_title,
            'product_fields_1_value' => $product->product_fields_1_value,
            'product_fields_2_title' => $product->product_fields_2_title,
            'product_fields_2_value' => $product->product_fields_2_value,
            'product_fields_3_title' => $product->product_fields_3_title,
            'product_fields_3_value' => $product->product_fields_3_value,
            'product_fields_4_title' => $product->product_fields_4_title,
            'product_fields_4_value' => $product->product_fields_4_value,
            'product_fields_5_title' => $product->product_fields_5_title,
            'product_fields_5_value' => $product->product_fields_5_value,
            'product_fields_6_title' => $product->product_fields_6_title,
            'product_fields_6_value' => $product->product_fields_6_value,
            'product_fields_7_title' => $product->product_fields_7_title,
            'product_fields_7_value' => $product->product_fields_7_value,
            'product_fields_8_title' => $product->product_fields_8_title,
            'product_fields_8_value' => $product->product_fields_8_value,
