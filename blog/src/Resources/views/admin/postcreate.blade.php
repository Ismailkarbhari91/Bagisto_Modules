...
@endpush
    <div class="content">
        <form method="POST" action="{{ route('blog.post.creates.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
                ...
                <div class="form-container">
                    ...
                    <div slot="body">
                        ...
                        <div class="control-group">
                            ...
                            <input id="title" name="title" type="text" class="control" value="">
                        </div>
                    ...
                    <div class="control-group">
                            ...
                            <input id="post_slug" name="post_slug" type="text" class="control" value="">
                    </div>
                    ...
                    <!--  -->
                    <!-- <div class="control-group">
                                <label for="locale" class="required">{{ __('Locale') }}</label>
